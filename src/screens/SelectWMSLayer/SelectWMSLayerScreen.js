...
class SelectWMSLayerScreen extends Component {
  ...
  _getLinkWMS() {
    ...
    console.log('Doi tuong layer duoc chon: ');
    console.log(layerData);
    //let link = `${layerData.linkRoot}&version=${layerData.version}&request=GetMap&layers=${layerData.layers}&cql_filter=${queryLayer}&styles=&bbox={minX},{minY},{maxX},{maxY}&width={width}&height={height}&srs=${layerData.src}&format=${layerData.format}&transparent=true`;
